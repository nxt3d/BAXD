...
error OperationProhibited(uint256 tokenId);

abstract contract ERC1155Expiry is ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function _mint(
        ...
        require(
            ...
            "ERC1155: newOwner cannot be the this contract"
        );
